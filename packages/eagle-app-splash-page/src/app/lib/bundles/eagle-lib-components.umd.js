(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@eagle/lib-scripts'), require('@angular/common'), require('@angular/router'), require('@angular/forms')) :
	typeof define === 'function' && define.amd ? define('@eagle/lib-components', ['exports', '@angular/core', '@eagle/lib-scripts', '@angular/common', '@angular/router', '@angular/forms'], factory) :
	(factory((global.eagle = global.eagle || {}, global.eagle['lib-components'] = {}),global.ng.core,global.libScripts,global.ng.common,global.ng.router,global.ng.forms));
}(this, (function (exports,core,libScripts,common,router,forms) { 'use strict';

var EagleControlComponent = /** @class */ (function () {
    function EagleControlComponent() {
        var log = libScripts.EGLogger.getLogger('EagleControlComponent');
        log(this);
    }
...
EagleControlComponent.ctorParameters = function () { return []; };
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router$$1, formBuilder) {
    ...
    Object.defineProperty(LoginComponent.prototype, "hasLoginError", {
        get: function () {
            var condition = this.loginFormSubmitted && !this.loginForm.valid;
            return Boolean(condition);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(LoginComponent.prototype, "loginErrorMessage", {
        get: function () {
    ...
    LoginComponent.prototype.resetSubmitted = function () {
...
var LocalRouterModule = router.RouterModule.forChild(moduleRoutes);
...
exports.ɵd = LoginComponent;
exports.ɵc = LocalRouterModule;
exports.ɵb = moduleRoutes;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=eagle-lib-components.umd.js.map
